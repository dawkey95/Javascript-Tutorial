 ...
 * while randomNum is the same as currentItem we will re-roll a random number
 * sets new random number as the currentItem index
 */
randomBtn.addEventListener('click', function() {
  let randomNum = currentItem;
